...
describe('legal pages', () => {
  ...
  it('documents TikTok data and ARTCI rights in the privacy policy', () => {
    ...
    expect(wrapper.text()).toContain('open_id')
    expect(wrapper.text()).toContain('Le jeton d’accès TikTok')
